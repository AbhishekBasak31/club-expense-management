...
import {
  ...
  closeCycle, updatePaymentStatus,
...
PartyQueryRouter.put   ("/:id/close",         asyncHandler(closeCycle));            // record final value, close the cycle
PartyQueryRouter.put   ("/:id/payment-status",asyncHandler(updatePaymentStatus));   // update client payment status
